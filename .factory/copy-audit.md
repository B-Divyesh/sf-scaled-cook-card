...
Reviewed 2026-09-01. Sentence counts exclude button labels and image alt text.
...
| Kitchen Pass purchase is unavailable. | 5 | Pass |
...
| Record the real yield, substitutions, and notes after cooking. | 10 | Pass |
| Start with a recipe you wrote or can import. | 10 | Pass |
| This card focuses on scaling and cooking that recipe. | 9 | Pass |
| The free cook card keeps scaling, cooking, and export. | 9 | Pass |
